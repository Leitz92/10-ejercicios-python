...
def LeerSecreto(palabras:set):
	aciertos = []
	# secreto = input("Introduce la palabra a adivinar:")
...
#* Mejora: Se crea un listado de palabras para que el programa elija una de manera aleatoria
palabras = ("castaña", "periquito", "trotamundos", "piramide", "eucalipto")
secreto, aciertos = LeerSecreto(palabras)
